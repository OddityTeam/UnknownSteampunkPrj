...
#define UE_PROJECT_NAME UnknownSteampunk
#define UE_TARGET_NAME UnknownSteampunkEditor
#define UE_MODULE_NAME "UnknownSteampunk"
...
#define UNKNOWNSTEAMPUNK_API DLLEXPORT
