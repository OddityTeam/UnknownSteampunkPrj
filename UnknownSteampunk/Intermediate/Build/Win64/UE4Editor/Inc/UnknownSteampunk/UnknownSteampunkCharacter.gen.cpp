...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SoaringVelocity_MetaData[];
#endif
		static const UE4CodeGen_Private::FDoublePropertyParams NewProp_SoaringVelocity;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AUnknownSteampunkCharacter_Statics::NewProp_SoaringVelocity_MetaData[] = {
		{ "Category", "Soaring" },
		{ "ModuleRelativePath", "UnknownSteampunkCharacter.h" },
	};
#endif
	const UE4CodeGen_Private::FDoublePropertyParams Z_Construct_UClass_AUnknownSteampunkCharacter_Statics::NewProp_SoaringVelocity = { "SoaringVelocity", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AUnknownSteampunkCharacter, SoaringVelocity), METADATA_PARAMS(Z_Construct_UClass_AUnknownSteampunkCharacter_Statics::NewProp_SoaringVelocity_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AUnknownSteampunkCharacter_Statics::NewProp_SoaringVelocity_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AUnknownSteampunkCharacter_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AUnknownSteampunkCharacter_Statics::NewProp_SoaringVelocity,
	...
	IMPLEMENT_CLASS(AUnknownSteampunkCharacter, 1427392882);
